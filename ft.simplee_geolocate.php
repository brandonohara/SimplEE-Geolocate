<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Simplee_geolocate_ft extends EE_Fieldtype {
		...
		function _include_head(){
			...
			$themes = $themes.'simplee_geolocate/';
		...
		function display_field($data){
			...
			foreach($data as $key => $value){
				...
				$out .= "<div class='simplee_geolocate_field' ".($key != "address" ? "style='display: none;'" : "").">";
			...
			$out .= "<div class='simplee_geolocate_field'>";
			$out .= "<a onclick='SimpleeGeolocate(".$this->field_id.")' class='simplee_geolocate_button'>Geolocate</a>";
			$out .= "</div>";
			$out .= "<div style='clear: both;'></div>";
			$out .= "<p class='simplee_geolocate_message' id='message_field_id_".$this->field_id."'></p>";
